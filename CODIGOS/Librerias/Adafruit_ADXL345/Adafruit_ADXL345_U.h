...
public:
  ...
  float getFreeFallDuration(void);
  void setFreeFallThreshold (float);
  void setFreeFallDuration (float);
  void setActivityThreshold(float threshold);
  void setActivityXYZ(bool state,bool coupled);
  ...
  void setInactivityXYZ(bool state, bool coupled);
