...
//should be set to -1.
                             ...
                             //busy pin on LoRa device 
#define DIO1 4                                 //DIO1 pin on LoRa device, used for RX and TX done 
#define DIO2 -1                                 //DIO2 pin on LoRa device, normally not used so set to -1 
#define DIO3 -1                                 //DIO3 pin on LoRa device, normally not used so set to -1
#define RX_EN 15                                //pin for RX enable, used on some SX126X devices, set to -1 if not used
#define TX_EN 2                                //pin for TX enable, used on some SX126X devices, set to -1 if not used 
#define SW -1                                   //SW pin on some Dorji LoRa devices, used to power antenna switch, set to -1 if not used
                                //on board LED, high for on
